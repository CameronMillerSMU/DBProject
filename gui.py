...
class DatabaseGUI:
    ...
    def show_section_entry_form(self, selected_value):
        ...
        course_id_label = tk.Label(self.master, text="Course ID:")
        course_id_label.pack()

        course_id_entry = tk.Entry(self.master)
        course_id_entry.pack()

        course_title_label = tk.Label(self.master, text="Course Title:")
        course_title_label.pack()

        course_title_entry = tk.Entry(self.master)
        course_title_entry.pack()

        course_description_label = tk.Label(self.master, text="Course Description:")
        course_description_label.pack()
        ...
        execute_button = tk.Button(self.master, text="Execute", command=lambda: self.execute_section_entry(course_id_entry.get(), course_title_entry.get(), course_description_entry.get(), department_code_entry.get()))
        execute_button.pack()
